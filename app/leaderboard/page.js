...
import {
  ...
  FaShieldAlt, FaMedal, FaFire, FaSync, FaUser
} from 'react-icons/fa';

const RANKS = [
  { level:1,  name:'Recruit',     Icon:FaShieldAlt, color:'text-gray-400',   border:'border-gray-600',   bg:'bg-gray-800'   },
  { level:2,  name:'Iron',        Icon:FaShieldAlt, color:'text-stone-400',  border:'border-stone-600',  bg:'bg-stone-800'  },
  { level:3,  name:'Bronze',      Icon:FaMedal,     color:'text-amber-500',  border:'border-amber-700',  bg:'bg-amber-900'  },
  { level:4,  name:'Silver',      Icon:FaMedal,     color:'text-slate-300',  border:'border-slate-500',  bg:'bg-slate-800'  },
  { level:5,  name:'Gold',        Icon:FaTrophy,    color:'text-yellow-400', border:'border-yellow-500', bg:'bg-yellow-900' },
  { level:6,  name:'Platinum',    Icon:FaGem,       color:'text-cyan-400',   border:'border-cyan-500',   bg:'bg-cyan-900'   },
  { level:7,  name:'Diamond',     Icon:FaGem,       color:'text-blue-400',   border:'border-blue-500',   bg:'bg-blue-900'   },
  { level:8,  name:'Master',      Icon:FaCrown,     color:'text-purple-400', border:'border-purple-500', bg:'bg-purple-900' },
  { level:9,  name:'Grandmaster', Icon:FaCrown,     color:'text-red-400',    border:'border-red-500',    bg:'bg-red-900'    },
  ...
  return (
    <div className="min-h-screen bg-discord-darkest p-3">
      <div className="max-w-lg mx-auto">
        ...
        {/* Rank tiers — flex-wrap (no horizontal scroll, no overflow) */}
        ...
        {user && profile && (
          <div className="bg-gradient-to-r from-purple-900 to-purple-800 border border-purple-600 rounded-xl p-3 mb-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-shrink-0 bg-purple-950 border border-purple-700 rounded-lg px-2 py-1 text-center w-14">
            ...
            <div className="mt-2 bg-purple-950 rounded-full h-1.5">
                ...
                <div key={player.id}
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`font-bold text-xs truncate ${isMe ? 'text-purple-300' : 'text-white'}`}>
                      {player.username}{isMe && <span className="text-purple-400 ml-1">(you)</span>}
                    </p>
                    <div className="flex items-center gap-1">
